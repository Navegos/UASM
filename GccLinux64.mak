...
ifeq ($(DEBUG),0)
extra_c_flags = $(warning_c_flags) -O3 -finline-functions -std=gnu17 -march=x86-64 -mabi=sysv -DNDEBUG -funsigned-char -Wwrite-strings -fPIC -fPIE -fstack-protector-strong -D_FORTIFY_SOURCE=2
OUTD=GccUnixR
else
extra_c_flags = $(warning_c_flags) -g -O0 -std=gnu17 -march=x86-64 -mabi=sysv -D_DEBUG -DDEBUG_OUT -funsigned-char -Wwrite-strings -fPIC -fPIE -fstack-protector-strong -D_FORTIFY_SOURCE=2
OUTD=GccUnixD
endif
