...
ifeq ($(DEBUG),0)
extra_c_flags = $(warning_c_flags) -O3 -finline-functions -std=gnu17 $(instr_c_flags) -mabi=sysv -target x86_64-pc-linux-gnu -DNDEBUG -funsigned-char -fwritable-strings -fPIC -fPIE -fstack-protector-strong -mstack-alignment=16 -D_FORTIFY_SOURCE=0
OUTD=GccUnixR
else
extra_c_flags = $(warning_c_flags) -g -O0 -std=gnu17 $(instr_c_flags) -mabi=sysv -target x86_64-pc-linux-gnu -D_DEBUG -DDEBUG_OUT -funsigned-char -fwritable-strings -fPIC -fPIE -fstack-protector-strong -mstack-alignment=16 -D_FORTIFY_SOURCE=2
OUTD=GccUnixD
endif
