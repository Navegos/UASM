...
ifeq ($(DEBUG),0)
extra_c_flags = $(warning_c_flags) -O3 -finline-functions -std=gnu17 $(instr_c_flags) -mabi=sysv -target x86_64-pc-linux-gnu -DNDEBUG -funsigned-char -fwritable-strings -fPIC -fPIE -fstack-protector-strong -mstack-alignment=16
OUTD=GccUnixR
else
extra_c_flags = $(warning_c_flags) -g -O0 -std=gnu17 $(instr_c_flags) -mabi=sysv -target x86_64-pc-linux-gnu -D_DEBUG -DDEBUG_OUT -funsigned-char -fwritable-strings -fPIC -fPIE -fstack-protector-strong -mstack-alignment=16
OUTD=GccUnixD
endif
...
ifeq ($(DEBUG),0)
	$(CC) -D __UNIX__ $(CFLAGS) $(OUTD)/main.o $(proj_obj) -Wl,-static -fPIC -fPIE -pie -Wl,-z,relro -Wl,-z,now -s -o $@ -Wl,-Map,$(OUTD)/$(TARGET1).map $(LDFLAGS)
else
	$(CC) -D __UNIX__ $(CFLAGS) $(OUTD)/main.o $(proj_obj) -Wl,-static -fPIC -fPIE -pie -Wl,-z,relro -Wl,-z,now -o $@ -Wl,-Map,$(OUTD)/$(TARGET1).map $(LDFLAGS)
endif
